...
<body>
    ...
    <p><b>PRIMERO.</b> EL PRESTAMISTA cederá en calidad de préstamo al PRESTATARIO la suma S/. <b>{{ number_format($monto, 2) }}</b>@if(!empty($monto_letras)) ({{ $monto_letras }}) @endif . Este monto será pagado por el PRESTATARIO una vez culminado el plazo pactado.</p>
