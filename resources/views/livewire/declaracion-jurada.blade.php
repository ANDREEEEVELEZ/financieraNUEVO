<div class="p-6 max-w-6xl mx-auto">
    ...
    <div class="declaracion-form p-6 bg-white rounded-lg shadow-lg">
        <form wire:submit.prevent="generarPDF">
            ...
            <div class="mt-8 flex justify-end space-x-4 border-t pt-6">
                ...
                >
                    ...
                    Generar PDF Declaración Jurada
                </button>
            </div>
        </form>
    </div>
    ...
    <div class="mt-8 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
        ...
        <ul class="text-sm text-yellow-700 space-y-1">
            ...
            <li>• Al generar el PDF, se incluirá toda la información completada en el formulario</li>
            <li>• El PDF resultante está listo para la firma del cliente e impresión</li>
            <li>• Asegúrese de revisar todos los datos antes de generar el documento final</li>
        </ul>
    </div>
</div>
