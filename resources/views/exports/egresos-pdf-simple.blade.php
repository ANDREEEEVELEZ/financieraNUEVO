...
<body>
    ...
    <div class="info-section">
        ...
        @if(isset($tipoEgreso) && $tipoEgreso !== 'todos')
            <p>Tipo:
                @if($tipoEgreso === 'operativo')
                    Operativo
                @elseif($tipoEgreso === 'administrativo')
                    Administrativo
                @else
                    {{ ucfirst($tipoEgreso) }}
                @endif
                ...
                <tbody>
                    @foreach($egresos as $egreso)
                        <tr>
                            ...
                            <td>
                                @if($egreso->tipo_egreso === 'operativo')
                                    <span style="color: #333;">
                                        Operativo
                                    </span>
                                @elseif($egreso->tipo_egreso === 'administrativo')
                                    <span style="color: #333;">
                                        Administrativo
                                    </span>
                                @else
                            ...
                            <td class="text-right" style="color: #333;">S/. {{ number_format($egreso->monto ?? 0, 2, ',', '.') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
