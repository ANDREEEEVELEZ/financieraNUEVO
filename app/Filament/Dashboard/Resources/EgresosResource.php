...
class EgresosResource extends Resource
{
        ...
        return $form
            ->schema([
                ...
                Forms\Components\DatePicker::make('fecha')
                    ...
                    ->default(now())
                    ->required()
                    ->disabled(fn (Get $get): bool => $get('tipo_egreso') === 'desembolso'),
                ...
                Forms\Components\Select::make('categoria_id')
                    ...
                    ->afterStateUpdated(function (Set $set, Get $get) {
                        $set('subcategoria_id', null);
                        // Generar descripción automática solo si no hay descripción manual
                ...
                Forms\Components\Textarea::make('descripcion')
                    ...
                    ->afterStateUpdated(function (Set $set, Get $get, $state) {
                        // Si el usuario borra completamente la descripción, regenerar automáticamente
                        if (empty(trim($state))) {
                ...
                Forms\Components\Select::make('prestamo_id')
                    ...
                    ->options(function (Get $get): array {
                        ...
                        // Si estamos editando, incluir el préstamo actual
                        ...
                        if ($currentPrestamoId) {
                            ...
                            // Si estamos creando, excluir los que ya tienen desembolso
    ...
    private static function updateDescripcionGasto(Set $set, Get $get): void
    {
        ...
        // Solo actualizar si no hay descripción manual o está vacía
