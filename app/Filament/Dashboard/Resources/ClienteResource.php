                ...
                ->tabs([
                    Tabs\Tab::make('Información Personal')
                        ->schema([
                            ...
                            DatePicker::make('persona.fecha_nacimiento')->label('Fecha de Nacimiento'),
                            TextInput::make('persona.celular')->label('Celular')->maxLength(9)->minLength(9)->numeric(),
                            TextInput::make('persona.correo')->label('Correo Electrónico')->email(),
                            TextInput::make('persona.direccion')->label('Dirección'),
                            TextInput::make('persona.distrito')->label('Distrito'),
                    ...
                    Tabs\Tab::make('Información Cliente')
                        ->schema([
                            TextInput::make('infocorp')->label('Infocorp'),
                            TextInput::make('ciclo')->label('Ciclo'),
                            TextInput::make('condicionVivienda')->label('Condición de Vivienda'),
                            TextInput::make('actividad')->label('Actividad'),
                            TextInput::make('condicionPersonal')->label('Condición Personal'),
                            TextInput::make('estadoCliente')->label('Estado Cliente'),
                        ])->columns(2),
                ])
        ]);
}
